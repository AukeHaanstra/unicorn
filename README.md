# Unicorn Backend Web Application examples illustrating Hexagonal Architecture and Domain Driven Design

This repository shows a three-layer architecture using best-practices for decoupling of its layers. It even shows
an adapter pattern to decouple a bounded context. This application can readily be refactored to hexagonal architecture
